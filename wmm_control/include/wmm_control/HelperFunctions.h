...
void send_joint_angles(ros::NodeHandle n, std::string robot_name, int degrees_of_freedom, Eigen::VectorXd position_gen3);
void send_joint_speeds(ros::NodeHandle n, std::string robot_name, int degrees_of_freedom, Eigen::VectorXd speed_gen3);
